...
const App = {
  ...
  start: async function() {
    ...
    try {
      ...
      const networkId = await web3.eth.net.getId(); // 获取当前的网络ID
      const deployedNetwork = starNotaryArtifact.networks[networkId]; // 获取网络配置
      this.meta = new web3.eth.Contract( // 初始化合约对象
