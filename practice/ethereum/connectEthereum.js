...
web3.eth.getBalance(address, (err, bal) => {
    if (!err) {
        console.log('balance by wei:', bal);
        const ether = web3.utils.fromWei(bal);
        console.log('balance by ether:', ether);
    } else {
        console.log('err', err)
    }
});
// 查询EOA(externally owned account)账户交易计数
web3.eth.getTransactionCount(address)
    .then(data => console.log('transaction count:', data));
// 查询CA账户
